...
public class TS_40_Verify_ContentEditorPage_MaintenancePageLink extends CommonMethods {
	...
	public void TC_02_Validate_PopUps_ContentRegion() {
		...
		String [] expectedList ={"Maintenance Page - Title", "Maintenance Page - Content"};
