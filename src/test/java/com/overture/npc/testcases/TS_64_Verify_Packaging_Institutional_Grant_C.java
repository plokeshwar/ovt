...
public class TS_64_Verify_Packaging_Institutional_Grant_C {
	...
	public void TC_01_Validate_Assignment_Table() {
		...
		String expected="Institutional Grant - C";		
		...
		Assert.assertEquals(actual, expected,"page did not navigated to the  Edit Packaging Institutional Grant - C page.");
	}
	...
	public void TC_02_Validate_Fixed_Link() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.fixedLink,"clicking on fixed link present in the Edit Packaging Institutional Grant - C page.");
	...
	public void TC_03_Validate_Save_Button() {
		...
		co.type(packagingPage.editPackageInputField,testData,"Entering some values into the text field in Edit Packaging Institutional Grant - C page.");
		co.click(packagingPage.editPackageSaveButton,"clicking the save button in Edit Packaging Institutional Grant - C page.");
		co.alertHandler(driver).accept();
		packagingPage= new PackagingPage().packagingPageElementsInit(driver);
		co.click(packagingPage.institutional_Grant_CLink,"clicking on Institutional Grant - C link.");
	...
	public void TC_04_Validate_Cancel_Button() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.editPackageCancelButton,"clicking on cancel button present in Institutional Grant - C page.");
		packagingPage= new PackagingPage().packagingPageElementsInit(driver);
	...
	public void TC_05_Validate_Factor_Link() {
		...
		co.click(packagingPage.factorLink,"clicking on Add Factor of link present in the Edit Packaging Institutional Grant - C page.");
	...
	public void TC_06_Validate_ValueTable_Link() {
		String ScreenshotName = new Object(){}.getClass().getEnclosingMethod().getName();
		cm.ReporterText("TestCase : " + ScreenshotName);
		co.click(packagingPage.ValueTableLink,"clicking on Value From Table link present in the Edit Packaging Institutional Grant - C page.");
